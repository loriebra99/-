$(document).ready(function() {
	...
	// Nombre
	var nomswsp = ['Fernanda Suarez Marcos','Fernanda Suarez Marcos','Fernanda Suarez Marcos','Fernanda Suarez Marcos','Fernanda Suarez Marcos',];
	var nomwsp = nomswsp[Math.floor(Math.random()*nomswsp.length)];
	// Primer mensaje
	var msjs1 = [
		'Hola! Tu quieres ver mi video Hot Ahora? <img class="emj" src="img/emoji/beso.png"/>',
		'Holaaa! quieres que te pase mi video hot? <img class="emj" src="img/emoji/besos.png"/>',
		'Holis!!! tu quieres ver mi video hot? porfa no lo pases a nadie <img class="emj" src="img/emoji/diablo.png"/>'
	];
	...
	var msjs2 = [
		...
		'Me voy a dormir asi que te dejo <img class="emj" src="img/emoji/vuelta.png"/>'
	];
	...
	var mensajes = [
		'<a href="http://adult.planetafreelancer.com/direct.php?id=XjbcWC0eWf" class="video"><span class="duracion">2:56</span></a>',
		msj2
	];
	var final = false;
